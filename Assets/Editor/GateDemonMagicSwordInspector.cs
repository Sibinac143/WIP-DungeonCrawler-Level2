...
public static class GateDemonMagicSwordInspector
{
    private const string OutputFolder = "Assets/Generated";
    private const string ReportPath =
        OutputFolder + "/GateDemonMagicSwordInspection.txt";
    ...
    [MenuItem(
        "Tools/Dungeon Game/Phase 4/Inspect Gate Demon and Magic Sword",
        priority = 500)]
    public static void Inspect()
    {
        ...
        report.AppendLine(
            "GATE DEMON + MAGIC SWORD ASSET INSPECTION");
        ...
        List<string> paths)
    {
        ...
        if (paths.Count == 0)
        {
            ...
            report.AppendLine(
                "The two packages may not have been imported yet, or their folder names do not match the package names.");
        ...
        List<string> paths)
    {
        ...
        foreach (string path in prefabPaths)
        {
            ...
            report.AppendLine(
                "Likely attachment bones: " +
                FindLikelyAttachmentBones(
                    prefab));
    ...
    private static string FindLikelyAttachmentBones(
        GameObject prefab)
    {
        string[] names =
            prefab
